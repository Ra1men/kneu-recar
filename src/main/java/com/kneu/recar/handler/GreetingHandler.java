...
public class GreetingHandler {
    ...
    public Mono<ServerResponse> getClients(ServerRequest request) {
        ...
        Flux<Client> clients = Flux.just(
                new Client(1L, "Ihor", "Stefanishyn", "67-753-45-84", "ihor.stef@gmail.com", "649139652"),
                new Client(2L, "Olha", "Sytnyk", "68-125-77-96", "olha.syt@gmail.com", "6343677895"),
                new Client(3L, "Sergey", "Kovalev", "93-763-23-56", "sergey.kov@gmail.com", "EP153567")
                )
